...
En `ejercicios/clase_2/ejercicios.py` encontrarás 3 ejercicios para practicar. Son de dificultad ligeramente superior al temario y no tienen solución: ¡intenta resolverlos tú!
...
git show Clase_2:ejercicios/clase_2/ejercicios.py > ejercicios/clase_2/tu-nombre.py
